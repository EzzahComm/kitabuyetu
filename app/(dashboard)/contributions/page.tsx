...
export default function ContributionsPage() {
  ...
  const {
    ...
    defaultValues: {
      paymentMethod: "mpesa",
      contributionDate: now.toISOString().split("T")[0],
    },
  });
  ...
  const columns = [
    ...
    },
    {
      key: "period",
      header: "Date",
      render: (row: ContributionRow) => formatDate(row.contribution_date),
    },
    {
      key: "paymentMethod",
      header: "Method",
    ...
    },
    {
      key: "status",
      header: "Status",
      render: (row: ContributionRow) => <StatusPill status={row.status} />,
    },
    {
      key: "createdAt",
      header: "Recorded",
      render: (row: ContributionRow) => formatDate(row.created_at),
    },
    {
      key: "receipt",
      header: "",
