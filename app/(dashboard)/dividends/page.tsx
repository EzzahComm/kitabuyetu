...
export default function DividendsPage() {
  ...
  const listQ = useQuery<PaginatedResult<Declaration>>({
    ...
    queryFn: () =>
      api.get<PaginatedResult<Declaration>>(`/dividends?page=${page}&limit=20`),
  });
      ...
      <PaginatedTable<Declaration>
        ...
        columns={[
          ...
          },
          {
            ...
            render: (d) => (
              <span className="text-xs text-muted-foreground">
                {POLICY_LABEL[d.policy_type] ?? d.policy_type}
              </span>
            ),
          },
          {
            ...
            render: (d) => (
              <StatusPill
                status={d.status}
                tone={d.status === "pending_approval" ? "pending" : undefined}
              />
            ),
          },
          {
            ...
            render: (d) => (
              <span className="font-mono">{fmtMoney(d.pool_amount)}</span>
            ),
          },
          {
            key: "members",
          ...
          },
          {
            ...
            className: "text-right",
            render: (d) => (
              <span className="font-mono">{fmtMoney(d.total_allocated)}</span>
            ),
          },
          {
            key: "paid",
          ...
          <form onSubmit={handleSubmit(onCreate)} className="space-y-4">
            <div className="grid gap-3 md:grid-cols-2">
              ...
              <div className="space-y-1">
                ...
                >
                  <option value="proportional_to_shares">
            ...
            <div className="space-y-1">
              <Label>
                Eligible share classes (leave empty = all active classes)
              </Label>
