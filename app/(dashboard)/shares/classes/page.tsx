...
export default function ShareClassesPage() {
  ...
  const openCreate = () => {
    setEditing(null);
    reset({ votingWeight: 1, transferAllowed: true, lockPeriodDays: 0 });
    setOpen(true);
  };
    ...
    <div className="space-y-6">
      ...
      <PaginatedTable
        ...
        columns={[
          ...
          },
          {
            key: "code",
            header: "Code",
            render: (c) => <Badge variant="outline">{c.code}</Badge>,
          },
          {
            key: "parValue",
            header: "Par value",
            ...
            render: (c) => (
              <span className="font-mono">{fmtMoney(c.par_value)}</span>
            ),
          },
          {
            key: "currentValue",
            ...
            render: (c) => (
              <span className="font-mono">
                {c.current_value ? fmtMoney(c.current_value) : "—"}
              </span>
            ),
          },
          {
            key: "cap",
            header: "Per-member cap",
            className: "text-right",
            render: (c) => (
              <span className="font-mono">
          ...
          },
          {
            ...
            header: "Voting",
            className: "text-right",
            render: (c) => <span className="font-mono">{c.voting_weight}</span>,
          },
          {
            key: "lock",
            header: "Lock days",
            className: "text-right",
            render: (c) => (
              <span className="font-mono">{c.lock_period_days}</span>
            ),
          },
          {
            key: "status",
      ...
      >
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>
              {editing ? `Edit ${editing.name}` : "New share class"}
            </DialogTitle>
          </DialogHeader>
            ...
            <div className="grid gap-3 md:grid-cols-2">
              ...
              <div className="space-y-1">
                ...
                <Input
                  ...
                  type="number"
                  step={0.01}
                  placeholder="Defaults to par value"
