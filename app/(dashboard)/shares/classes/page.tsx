      ...
      <PaginatedTable
        ...
        columns={[
          ...
          { key: 'code', header: 'Code', render: (c) => <Badge variant="outline">{c.code}</Badge> },
          {
            ...
            render: (c) => <span className="font-mono">{fmtMoney(c.par_value)}</span>,
          },
          {
            key: 'currentValue',
          ...
          },
          {
            ...
            header: 'Lock days',
            className: 'text-right',
            render: (c) => <span className="font-mono">{c.lock_period_days}</span>,
          },
          {
            key: 'status',
            header: 'Status',
            render: (c) => <StatusPill status={c.is_active ? 'active' : 'inactive'} size="sm" />,
          },
        ]}
      />
