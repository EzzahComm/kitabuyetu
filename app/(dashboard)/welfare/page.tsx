...
export default function WelfarePage() {
  ...
  const columns = [
    ...
    },
    {
      key: 'member',
      header: 'Member',
      render: (row: WelfareRequestRow) => <span className="text-sm">{row.member_name}</span>,
    },
    {
      key: 'amount',
      header: 'Requested',
    ...
    { key: 'status', header: 'Status', render: (row: WelfareRequestRow) => <StatusPill status={row.status} /> },
    {
      key: 'created_at',
      header: 'Date',
      render: (row: WelfareRequestRow) => <span className="text-xs">{formatDate(row.created_at)}</span>,
    },
    {
      key: 'actions',
      header: '',
          ...
          <form onSubmit={reqForm.handleSubmit(onSubmitRequest)} className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              {reqForm.formState.errors.title && (
                <p className="text-xs text-destructive">{reqForm.formState.errors.title.message as string}</p>
              )}
            </div>
            <div className="space-y-1">
            ...
            <DialogFooter>
              <Button type="button" variant="outline" onClick={() => setOpenRequest(false)}>
                Cancel
              </Button>
      ...
      <Dialog open={openPool} onOpenChange={setOpenPool}>
        <DialogContent className="max-w-md">
          ...
          <form onSubmit={poolForm.handleSubmit(onSubmitPool)} className="space-y-4">
            ...
            <DialogFooter>
              <Button type="button" variant="outline" onClick={() => setOpenPool(false)}>
                Cancel
              </Button>
        ...
        >
          <DialogContent className="max-w-md">
            ...
            <DialogFooter className="gap-2 sm:gap-2">
              <Button variant="outline" onClick={closeReview} disabled={reviewBusy}>
                Cancel
              </Button>
              <Button
                variant="destructive"
