        ...
        <>
            ...
            <Card>
              <CardContent className="flex flex-col items-center gap-2 py-12 text-center">
                ...
                <p className="max-w-md text-sm text-muted-foreground">
                  Every loan is on schedule, no members are in poor or high-risk
                  credit tiers, contributions are active, and pending welfare
                  requests are fresh.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-base text-amber-700">
                  <Clock className="h-4 w-4" /> Overdue loans (
                  {r.overdueLoans.length})
                </CardTitle>
              </CardHeader>
              <CardContent className="p-0">
                <PaginatedTable
                  data={singlePage(
                    r.overdueLoans.map((l) => ({ ...l, id: l.loanId })),
                  )}
                  isLoading={false}
                  onPageChange={() => {}}
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-base text-red-700">
                  <Landmark className="h-4 w-4" /> Defaulted &amp; written-off
                  loans ({r.defaultedLoans.length})
                </CardTitle>
              </CardHeader>
              <CardContent className="p-0">
                <PaginatedTable
                  data={singlePage(
                    r.defaultedLoans.map((l) => ({ ...l, id: l.loanId })),
                  )}
                  isLoading={false}
                  onPageChange={() => {}}
                  ...
                  columns={[
                    ...
                    },
                    {
                      ...
                      header: "Status",
                      render: (l) => (
                        <StatusPill status={l.status} tone="negative" />
                      ),
                    },
                  ]}
                />
          ...
          {r.highRiskMembers.length > 0 && (
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-base text-amber-700">
                  <ShieldAlert className="h-4 w-4" /> Members in poor or
                  high-risk tier ({r.highRiskMembers.length})
                </CardTitle>
              </CardHeader>
              <CardContent className="p-0">
                <PaginatedTable
                  data={singlePage(
                    r.highRiskMembers.map((m) => ({ ...m, id: m.memberId })),
                  )}
                  isLoading={false}
                  onPageChange={() => {}}
                  ...
                  columns={[
                    ...
                    },
                    {
                      ...
                      render: (m) => (
                        <StatusPill
                          status={m.reliabilityTier}
                          tone={TIER_TONE[m.reliabilityTier]}
                        />
                      ),
                    },
                    {
                      ...
                      render: (m) => (
                        <Button asChild size="sm" variant="ghost">
                          <Link href={`/credit-scores/${m.memberId}`}>
                            View score
                          </Link>
                        </Button>
                      ),
          ...
          {r.idleMembers.length > 0 && (
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-base text-amber-700">
                  <UserX className="h-4 w-4" /> Idle members (
                  {r.idleMembers.length})
                </CardTitle>
              </CardHeader>
              <CardContent className="p-0">
                <PaginatedTable
                  data={singlePage(
                    r.idleMembers.map((m) => ({ ...m, id: m.memberId })),
                  )}
                  isLoading={false}
                  onPageChange={() => {}}
                  ...
                  columns={[
                    ...
                    },
                    {
                      ...
                      header: "Joined",
                      render: (m) => (
                        <span className="font-mono text-xs">{m.joinedAt}</span>
                      ),
                    },
                    {
          ...
          {r.staleWelfareRequests.length > 0 && (
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-base text-amber-700">
                  <Heart className="h-4 w-4" /> Welfare requests pending &gt; 14
                  days ({r.staleWelfareRequests.length})
                </CardTitle>
              </CardHeader>
              <CardContent className="p-0">
                <PaginatedTable
