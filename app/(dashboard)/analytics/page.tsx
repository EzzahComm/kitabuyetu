...
const fmtInt = (v: number | string | null | undefined) => new Intl.NumberFormat('en-KE').format(Number(v ?? 0));
      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            <label htmlFor="period" className="text-xs text-muted-foreground ml-2">
              Period
            </label>
            <select
              id="period"
        ...
        <>
          ...
          <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-4">
            ...
            <StatCard
              ...
              description={
                s.dividends.lastDeclarationLabel ? `Last: ${s.dividends.lastDeclarationLabel}` : 'No declarations yet'
              }
              icon={ReceiptText}
            />
            <StatCard
            ...
            <CardContent>
              <div className="grid gap-3 md:grid-cols-3">
                ...
                <HealthMetric
                  ...
                  tone={Number(s.financialHealth.netPosition) >= 0 ? 'positive' : 'negative'}
                  highlight
                />
              </div>
            </CardContent>
          ...
          <div className="grid gap-3 lg:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-base">Loan repayments over time</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-64">
