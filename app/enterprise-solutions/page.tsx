...
export default function EnterpriseSolutionsPage() {
  return (
    ...
    >
      <p>
        NGOs, federations and umbrella bodies rarely oversee a single chama or
        SACCO — they run dozens, each with its own officers, its own meeting
        calendar, and its own ledger that needs to stay exactly that: its own.
        The Enterprise portal gives an institution one login and a portfolio
        view across every group it supports, without merging any group&apos;s
        books into another&apos;s.
      </p>

      <h2>What&apos;s live today</h2>
      <ul className="ml-5 list-disc space-y-2">
        <li>
          Multi-group registration under a single organization account, with
          branches.
        </li>
        <li>
          A portfolio overview across every group you support, separate from any
          individual group&apos;s dashboard.
        </li>
        <li>
          Programs with their own budget and criteria, and the groups enrolled
          in each.
        </li>
        <li>
          Funding and disbursements — money out to the groups you back, drawn
          against a budget and held to a second approver.
        </li>
        <li>
          Reports: budget variance across programs, and spend broken down by
          donor.
        </li>
        <li>
          Organization staff accounts with defined roles, one-time-code sign-in,
          and an audit trail of what they did.
        </li>
        <li>Your own logo and colours on what the organization sends out.</li>
        <li>
          Per-group visibility for the organization, per-group privacy for the
          group&apos;s own members.
        </li>
      </ul>
      ...
      <p>
        API keys and webhooks, for institutions that want to connect Kitabu Yetu
        into their own systems. The screens are designed but the issuance and
        delivery backend is not built — so this is genuinely not available yet,
        and we would rather say so here than let you find out after signing up.
      </p>
