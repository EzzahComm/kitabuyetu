    ...
    >
      <div className="grid gap-4 sm:grid-cols-3">
        <a
          ...
          className="flex flex-col items-start gap-2 rounded-xl border border-slate-200 p-5 transition-colors hover:border-brand-orange-300 hover:bg-brand-orange-50/50"
        >
          <Mail className="h-5 w-5 text-brand-orange-600" />
        ...
        <div className="flex flex-col items-start gap-2 rounded-xl border border-slate-200 p-5">
          <Phone className="h-5 w-5 text-brand-orange-600" />
          <span className="text-sm font-semibold text-slate-900">Phone</span>
          <a href="tel:+254717548646" className="text-sm text-slate-500 hover:text-brand-orange-600">+254 717 548 646</a>
          <a href="tel:+254738692698" className="text-sm text-slate-500 hover:text-brand-orange-600">+254 738 692 698</a>
        </div>
        <div className="flex flex-col items-start gap-2 rounded-xl border border-slate-200 p-5">
