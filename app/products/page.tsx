...
export const metadata: Metadata = {
  title: "Products",
  description:
    "Bookkeeper, Chama Reminder, Fundraise / Changi$ha and Enterprise — the Kitabu Yetu product family.",
};
      ...
      <div className="not-prose grid gap-5 sm:grid-cols-2">
        {PRODUCT_PILLARS.map((product) => (
          ...
          >
            ...
            <h2 className="mt-4 font-display text-xl font-normal text-brand-blue-900">
              {product.title}
            </h2>
