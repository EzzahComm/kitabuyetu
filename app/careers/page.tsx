          ...
          <div className="mx-auto grid max-w-5xl gap-6 lg:grid-cols-3">
            <article className="border-t-2 border-indigo-600 pt-5">
              ...
              <p className="mt-3 leading-7 text-gray-500 dark:text-gray-300">
                Your work will be used by real groups making real decisions
                about their families, businesses and futures.
              </p>
            </article>
            ...
            <div className="grid gap-8 sm:grid-cols-2">
              <div>
                ...
                <p className="mt-2 leading-7 text-gray-500 dark:text-gray-300">
                  The best product decisions begin with the group, not the
                  feature list.
                </p>
              </div>
              <div>
                ...
                <p className="mt-2 leading-7 text-gray-500 dark:text-gray-300">
                  Clear records, careful defaults and honest communication are
                  part of the product.
                </p>
              </div>
              <div>
                ...
                <p className="mt-2 leading-7 text-gray-500 dark:text-gray-300">
                  We improve the system, the process and the community around us
                  as we go.
                </p>
              </div>
              <div>
                ...
                <p className="mt-2 leading-7 text-gray-500 dark:text-gray-300">
                  Curiosity is practical here. Ask the next question and bring
                  others along.
                </p>
              </div>
            </div>
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            <div id="teams">
              ...
              <p className="mt-4 leading-7 text-gray-500 dark:text-gray-300">
                Our work sits where community insight, product craft, technology
                and operations meet.
              </p>
            ...
            <div id="benefits">
              ...
              <p className="mt-4 leading-7 text-gray-500 dark:text-gray-300">
                As the team grows, we are building practical support around the
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_1.1fr]">
            <div>
              ...
              <p className="mt-4 max-w-lg leading-7 text-gray-500 dark:text-gray-300">
                We are keeping the team small while we get the fundamentals
                right. When a role opens, this is where you will find the work,
                the expectations and the application process.
              </p>
            </div>
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-trueGray-700 dark:bg-trueGray-900">
              ...
              <div className="mt-8 border-t border-gray-200 pt-8 text-center dark:border-trueGray-700">
                ...
                <p className="mx-auto mt-3 max-w-md leading-7 text-gray-500 dark:text-gray-300">
                  We do not have a published vacancy that matches these filters
                  today. We would still like to hear from people who understand
                  this work.
                </p>
                <a
