...
function AcceptInviteBody() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>
          Join {invite?.organizationName ?? "your organization"}
        </CardTitle>
        <CardDescription>
      ...
      <CardContent className="space-y-4">
        ...
        {step === "success" && (
          <div className="flex flex-col items-center gap-3 py-6">
            ...
            <p className="text-sm text-muted-foreground text-center">
              Your account is ready. Log in to start working with{" "}
              {invite?.organizationName ?? "your organization"}.
            </p>
        ...
        {step === "declined" && (
          <div className="flex flex-col items-center gap-3 py-6">
            ...
            <p className="text-sm text-muted-foreground text-center">
              You won&apos;t be added as staff for{" "}
              {invite?.organizationName ?? "this organization"}. If this was a
