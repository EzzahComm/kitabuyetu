    ...
    <div className="mx-auto max-w-5xl space-y-12 p-6 lg:p-10">
        ...
        <Card>
          <CardContent className="space-y-3 p-6">
            ...
            <p className="text-base">
              Body — Inter Regular. Build vibrant communities.
            </p>
            <p className="text-sm text-muted-foreground">
              Muted caption — supporting copy.
            </p>
            <p className="money font-mono text-lg">
              KES 1,234,567.00 — DM Mono, tabular figures
            </p>
          </CardContent>
        </Card>
      </Section>
      ...
      <Section id="alerts" title="Alerts">
        <Alert>
          ...
          <AlertDescription>
            Your monthly statement is ready to download.
          </AlertDescription>
        </Alert>
        <Alert variant="destructive">
          ...
          <AlertDescription>
            This payment looks unusual for this member. Review before approving.
          </AlertDescription>
        </Alert>
      </Section>
      ...
      <Section id="dialogs" title="Confirmation UX for money actions">
        <Card>
          <CardContent className="flex flex-wrap gap-2 p-6">
            ...
            <Button onClick={() => setMoneyOpen(true)}>
              Open money action dialog
            </Button>
          </CardContent>
        </Card>
        <ConfirmDialog
        ...
        <Card>
          <CardContent className="p-6">
            <Tabs defaultValue="tab1">
              ...
              >
                Content for tab one — use for switching between related datasets
                or views.
              </TabsContent>
              <TabsContent
                value="tab2"
                className="mt-4 text-sm text-muted-foreground"
              >
                Content for tab two — maintains scroll position and form state
                between switches.
              </TabsContent>
              <TabsContent
                value="tab3"
                className="mt-4 text-sm text-muted-foreground"
              >
                Content for tab three — keyboard accessible (arrow keys +
                Home/End).
              </TabsContent>
            </Tabs>
          </CardContent>
      ...
      <Section id="tables" title="Paginated table">
            ...
            <PaginatedTable
              ...
              columns={[
                ...
                },
                {
                  ...
                  header: "Balance",
                  render: (row) => (
                    <p className="text-right font-mono text-sm">{row.amount}</p>
                  ),
                },
              ]}
              onPageChange={() => {}}
        ...
        <p className="text-sm text-muted-foreground">
          Shows paginated data with responsive column hiding, error states, and
          loading skeletons. Handles permission denials and fetch failures with
          semantic{" "}
          ...
          <CardContent className="space-y-4 p-6">
            <div>
              <h3 className="mb-2 text-sm font-semibold text-foreground">
                PortalSidebar + TopBar
              </h3>
              <p className="text-sm text-muted-foreground">
                Standardized layout for all authenticated portals (dashboard,
                admin, enterprise, member, reminder). Sidebar handles
                navigation, TopBar shows breadcrumbs/actions. See{" "}
                <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-xs">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Marketing pages (public routes). Wraps each page with navigation
                and footer. See{" "}
                <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-xs">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Legacy wrapper; most marketing pages now use
                SiteHeader/SiteFooter directly. Still used in a few places for
                compatibility.
              </p>
            </div>
          </CardContent>
      ...
      <Section id="forms" title="Form components (helpers)">
        ...
        <p className="text-sm text-muted-foreground">
          Standardized form field wrappers for Label + Input/Select/Textarea.
          Use{" "}
          <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-xs">
            FormSection
          </code>{" "}
          for individual fields with optional error/hint,{" "}
          <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-xs">
            FormFieldGroup
          </code>{" "}
          for side-by-side fields, and{" "}
          <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-xs">
            FormDivider
          </code>{" "}
          to separate form sections.
        </p>
      </Section>
      ...
      <Section id="page-structure" title="Page structure components (helpers)">
        <Card>
          <CardContent className="space-y-6 p-6">
            <div>
              ...
              >
                <p className="text-sm text-muted-foreground">
                  Content area with consistent Card wrapper and padding.
                </p>
              </PageSection>
            </div>
            <div>
              ...
              <div className="rounded-md border p-4 bg-muted/30">
                <p className="text-sm text-muted-foreground mb-4">
                  Bottom of form with consistent spacing:
                </p>
                <FormActions>
        ...
        <p className="text-sm text-muted-foreground">
          ...
          wraps content areas in Card with optional title/description/action.{" "}
          <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-xs">
            FormActions
          </code>{" "}
          groups buttons at the bottom with separator and consistent alignment
          options.
        </p>
      </Section>
    </div>
