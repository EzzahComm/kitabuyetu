      ...
      <Tabs defaultValue="keys">
        <TabsList>
          <TabsTrigger value="keys">
            <KeyRound size={14} className="mr-1.5" /> API Keys
          </TabsTrigger>
          <TabsTrigger value="webhooks">
            <Webhook size={14} className="mr-1.5" /> Webhooks
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="keys" className="space-y-4">
          <div className="flex items-center justify-between">
            <p className="text-sm text-muted-foreground">
              Keys carry the permissions of their scopes. Treat them like
              passwords.
            </p>
                ...
                columns={[
                  ...
                  },
                  {
                    ...
                    render: (k) => (
                      <StatusPill
                        status={k.status}
                        tone={k.status === "active" ? "positive" : "neutral"}
                        label={k.status}
                        size="sm"
                      />
                    ),
        ...
        <TabsContent value="webhooks" className="space-y-4">
          <div className="flex items-center justify-between">
            <p className="text-sm text-muted-foreground">
              We POST events to these endpoints. Failing endpoints retry with
              backoff.
            </p>
            <Button size="sm">
                ...
                <CardContent className="p-4">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex shrink-0 flex-col items-end gap-1.5">
                      <StatusPill
                        status={h.status}
                        tone={h.status === "active" ? "positive" : "negative"}
                        label={h.status}
                        size="sm"
                      />
          ...
          {step === "form" ? (
            ...
            <>
              <DialogHeader>
                ...
                <DialogDescription>
                  This is the only time we&apos;ll show the full key. Store it
                  securely.
                </DialogDescription>
              </DialogHeader>
              <div className="flex items-center gap-2 rounded-md border bg-muted/50 p-2">
                ...
                <Button size="sm" variant="outline" onClick={copyKey}>
                  {copied ? (
                    <>
                      <Check size={14} className="mr-1 text-brand-600" /> Copied
                    </>
                  ) : (
                    <>
              ...
              <Alert>
                ...
                <AlertDescription>
                  If you lose it, revoke this key and create a new one — it
                  can&apos;t be recovered.
                </AlertDescription>
              </Alert>
              <DialogFooter>
