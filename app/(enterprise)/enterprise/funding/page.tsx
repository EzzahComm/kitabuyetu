    ...
    <div className="space-y-6">
                ...
                {(dash?.programs ?? []).map((pr) => {
                  ...
                  return (
                    <div
                      ...
                      onKeyDown={(e) => {
                        if (e.key === 'Enter' || e.key === ' ') setViewProgramId(pr.id);
                      }}
                    >
                      <div className="flex items-center justify-between gap-2">
                        ...
                        <div className="flex items-center gap-1.5 shrink-0">
                          <Badge
                            variant={pr.status === 'active' ? 'success' : 'outline'}
      ...
      <Card>
        <CardHeader className="pb-3">
          ...
          <p className="text-xs text-muted-foreground">
            Programs grouped by funding source, with settled spend broken down by the linked group that received it.
          </p>
        </CardHeader>
        <CardContent>
    ...
    >
      <DialogContent className="max-w-sm">
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-1">
            <Label>
              Funding source <span className="text-muted-foreground text-xs">(optional)</span>
            </Label>
            <Input
              value={source}
        ...
        <DialogFooter>
          ...
          <Button onClick={() => deposit.mutate()} disabled={!ok || deposit.isPending}>
            Record deposit
          </Button>
        </DialogFooter>
      </DialogContent>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="space-y-1">
              ...
              <select
                ...
                value={type}
                onChange={(e) => setType(e.target.value as (typeof PROGRAM_TYPES)[number][0])}
              >
    ...
    >
      <DialogContent className="max-w-sm">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="space-y-1">
              ...
              <select
                className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm"
                value={type}
                onChange={(e) => setType(e.target.value as (typeof DISBURSEMENT_TYPES)[number][0])}
              >
          ...
          <div className="space-y-1">
            <Label>
              Fund from program <span className="text-muted-foreground text-xs">(optional)</span>
            </Label>
            <select
              className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm"
              value={programId}
        ...
        <DialogFooter>
          ...
          <Button onClick={() => disburse.mutate()} disabled={!ok || disburse.isPending}>
            Disburse
          </Button>
        </DialogFooter>
      </DialogContent>
