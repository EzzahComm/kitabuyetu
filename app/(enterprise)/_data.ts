...
export const webhooks: Webhook[] = [
  {
    id: "w1",
    url: "https://api.hisa.africa/hooks/kitabu",
    events: ["contribution.created", "loan.disbursed", "member.joined"],
    status: "active",
    lastDelivery: "30s ago · 200",
  },
  {
    id: "w2",
    url: "https://reports.hisa.africa/ingest",
    events: ["payout.completed"],
    status: "failing",
    lastDelivery: "5 min ago · 503",
  },
];
