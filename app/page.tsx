...
export default function Home() {
  return (
    <div className={fraunces.variable}>
      ...
      <SectionTitle preTitle="Who it's for" title="Built for the groups Kenyans already organize.">
        Chamas, SACCOs, welfare groups, investment groups, CBOs and the organizations that support them — not a generic
        business tool adapted to fit.
      </SectionTitle>

      <WhoItsFor />

      <SectionTitle preTitle="The problem" title="Your group already keeps records. They just aren't reliable.">
        Every group tracks its money somehow. The problem is never effort — it&rsquo;s that notebooks, spreadsheets and
        scattered M-Pesa messages don&rsquo;t add up the same way twice.
      </SectionTitle>

      <ProblemSolution />

      <SectionTitle preTitle="The whole picture" title="Everything your group needs, in one place.">
        No more switching between notebooks, spreadsheets, M-Pesa messages and WhatsApp to understand your group&apos;s
        finances.
      </SectionTitle>
      ...
      <SectionTitle preTitle="Ecosystem" title="From managing your group to growing it.">
        The Kitabu Yetu Ecosystem connects organized groups to opportunities, knowledge and resources beyond their own
        savings.
      </SectionTitle>
      ...
      <SectionTitle preTitle="How it works" title="From M-Pesa to your books.">
        Payments and records work together. Members pay through M-Pesa and Kitabu Yetu helps match payments to members
        and update the group&apos;s records.
      </SectionTitle>
      ...
      <SectionTitle preTitle="Pricing" title="Simple pricing. Start small. Grow with us.">
        SMS included in every plan, with affordable top-ups when you need more.
      </SectionTitle>

      <Container className="mb-20">
        <div className="max-w-2xl mx-auto text-center">
          <p className="text-xl font-medium text-gray-800 dark:text-gray-200">Bookkeeper from KES 150/month</p>
          <p className="mt-2 text-xl font-medium text-gray-800 dark:text-gray-200">Chama Reminder from KES 100/month</p>
          <div className="mt-8">
            <Link
              href="/pricing"
              className="inline-flex min-h-12 items-center justify-center rounded-md bg-brand-600 px-6 py-3 text-lg font-semibold text-white transition-colors hover:bg-brand-700 focus-visible:ring-2 focus-visible:ring-brand-500"
