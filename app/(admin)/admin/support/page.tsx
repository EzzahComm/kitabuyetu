...
export default function SupportPage() {
  ...
  const slaBreached = items.filter(
    (t) =>
      t.sla_breach_at &&
      new Date(t.sla_breach_at) < new Date() &&
        ...
        columns={[
          {
            ...
            render: (ticket) => (
              <div>
                <p className="font-medium text-gray-900 max-w-[280px] truncate">
                  {ticket.subject}
                </p>
          ...
          },
          {
            ...
            render: (ticket) => (
              <span className="text-sm text-gray-600">
                {ticket.group_name ?? ticket.member_name ?? "—"}
              </span>
            ),
          },
          {
          ...
          },
          {
            key: "sla",
            header: "SLA",
            render: (ticket) => <SlaChip breachAt={ticket.sla_breach_at} />,
          },
          {
            key: "replies",
            header: "Replies",
