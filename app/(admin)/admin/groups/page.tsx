...
export default function GroupsPage() {
  ...
  const tableData = data
    ? { items, total, page: data.page, pageSize: 25, totalPages }
    : null;
        ...
        columns={[
          ...
          },
          {
            ...
            render: (grp) =>
              grp.plan ? (
                <span
                  className={`text-xs font-semibold px-2 py-0.5 rounded-full capitalize ${PLAN_BADGE[grp.plan] ?? "bg-gray-100 text-gray-600"}`}
                >
                  {grp.plan}
                </span>
              ) : (
          ...
          },
          {
            ...
            render: (grp) => (
              <span className="font-medium">{grp.member_count}</span>
            ),
          },
          {
          ...
          },
          {
            ...
            header: "Health",
            render: (grp) => (
              <HealthBadge score={grp.health_score} rag={grp.health_rag} />
            ),
          },
          {
            key: "created_at",
