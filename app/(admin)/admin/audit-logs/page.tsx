        ...
        columns={[
          {
            ...
            render: (log) => (
              <span
                className={`text-[10px] font-bold px-2 py-0.5 rounded border ${ACTION_STYLE[log.action] ?? 'bg-muted text-muted-foreground border-border'}`}
              >
                {log.action}
              </span>
            ),
          },
          {
            ...
            header: 'Table',
            render: (log) => (
              <span className="font-mono text-xs text-muted-foreground font-medium">{log.table_name}</span>
            ),
          },
          {
            key: 'actor_name',
            header: 'Actor',
            render: (log) => (
              <span className="font-mono text-xs text-muted-foreground">{log.actor_name ?? 'System'}</span>
            ),
          },
          {
            key: 'group_name',
          ...
          },
          {
            ...
            header: 'Timestamp',
            render: (log) => (
              <span className="font-mono text-xs text-muted-foreground">{formatDate(log.created_at)}</span>
            ),
          },
        ]}
      />
