...
export default function AuditLogsPage() {
  ...
  const tableData = data
    ? { items, total, page: data.page, pageSize: 50, totalPages }
    : null;
        ...
        columns={[
          {
            ...
            render: (log) => (
              <span
                className={`text-[10px] font-bold px-2 py-0.5 rounded border ${ACTION_STYLE[log.action] ?? "bg-gray-50 text-gray-600 border-gray-200"}`}
              >
                {log.action}
              </span>
            ),
          ...
          },
          {
            ...
            header: "Record ID",
            render: (log) => (
              <span className="font-mono text-xs text-gray-400 truncate max-w-[120px] inline-block align-bottom">
