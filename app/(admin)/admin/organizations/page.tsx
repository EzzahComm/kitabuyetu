...
import { useAdminOrganizations, useCreateOrganization, useUpdateOrganizationStatus } from '@/hooks/use-admin';
...
const TYPE_LABEL: Record<string, string> = Object.fromEntries(ORG_TYPES.map((t) => [t.value, t.label]));
    ...
    <div className="space-y-5">
      ...
      <PaginatedTable<AdminOrgRow>
        ...
        columns={[
          ...
          },
          {
            ...
            render: (org) => (
              <span
                className={`text-xs font-semibold px-2 py-0.5 rounded-full ${TYPE_BADGE[org.type] ?? 'bg-muted text-muted-foreground'}`}
              >
          ...
          },
          {
            ...
            render: (org) => <span className="font-medium">{org.group_count}</span>,
          },
          {
            key: 'memberReach',
            header: 'Member Reach',
            className: 'text-right',
            render: (org) => <span className="font-medium">{Number(org.member_reach).toLocaleString()}</span>,
          },
          {
            key: 'wallet',
            header: 'Wallet',
            className: 'text-right',
            render: (org) => <span className="text-green-600 font-medium">{formatKES(org.wallet_balance)}</span>,
          },
          {
            key: 'status',
            header: 'Status',
          ...
          },
          {
            key: 'onboarded',
            header: 'Onboarded',
            render: (org) => <span className="text-xs text-muted-foreground">{formatDate(org.created_at)}</span>,
          },
          {
            key: 'actions',
            header: '',
              ...
              <div className="grid gap-3 sm:grid-cols-2 rounded-md border bg-muted/20 p-3">
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    onChange={(e) => setCustom({ ...custom, monthlyFee: e.target.value })}
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    onChange={(e) => setCustom({ ...custom, maxLinkedGroups: e.target.value })}
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    onChange={(e) => setCustom({ ...custom, maxStaff: e.target.value })}
                    placeholder="Unlimited"
                  />
                </div>
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    onChange={(e) => setCustom({ ...custom, maxFundingPrograms: e.target.value })}
                    placeholder="Unlimited"
                  />
                </div>
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    onChange={(e) => setCustom({ ...custom, smsAllowanceIncluded: e.target.value })}
                    placeholder="0"
                  />
                </div>
              </div>
      ...
      <Dialog open={!!confirm} onOpenChange={() => setConfirm(null)}>
        <DialogContent className="max-w-sm">
          <DialogHeader>
            <DialogTitle className="capitalize">{confirm?.action} organization</DialogTitle>
          </DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              className={
                confirm?.action === 'deactivate' ? 'bg-red-600 hover:bg-red-700' : 'bg-green-600 hover:bg-green-700'
              }
            >
              Confirm
            </Button>
