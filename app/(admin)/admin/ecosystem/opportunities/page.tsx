...
const EMPTY_FORM = {
  ...
  title: '',
  description: '',
  opportunity_type: 'grant' as Opportunity['opportunity_type'],
  category: '',
  amount_min: '',
  amount_max: '',
  currency: 'KES',
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        setForm((f) => ({ ...f, opportunity_type: v as Opportunity['opportunity_type'] }))
                      }
                    >
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    placeholder="Leave blank to use the in-app application form"
                  />
                </div>
              ...
              <CardContent className="flex flex-col gap-3 p-5 sm:flex-row sm:items-start sm:justify-between">
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2">
                    <Link href={`/admin/ecosystem/opportunities/${o.id}`} className="font-semibold hover:underline">
                      {o.title}
                    </Link>
