...
export default function ImpactPage() {
  return (
    <PageShell title="Impact" description="What digitizing group administration is changing.">
      <p>
        Every group that moves off a paper book and onto Kitabu Yetu gets the same three things: a ledger nobody can
        lose or falsify, a member who can check their own balance without waiting for a meeting, and a treasurer who
