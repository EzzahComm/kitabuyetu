 ...
 * for what each pillar enables (real features for multigroup organizations
 * and programs, aspirational positioning for donors and marketplace which
 * are newer).
 */
    ...
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <main id="main" className="flex-1">
        ...
        >
          ...
          funding, training, financial products, professional support and
          markets. Kitabu Yetu connects those relationships without taking the
          group&apos;s own book away from it.
        </SectionTitle>
          ...
          <div className="not-prose grid gap-4 sm:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm text-brand-blue-900/65">
                The core ledger — contributions, loans, welfare and shares on
                one double-entry book.
              </p>
            </Link>
            <Link
