...
export default function MultigroupOrganizationsPage() {
  return (
    ...
    >
      <p>
        Federations, NGOs and umbrella bodies run this way as a matter of course
        — a network of groups, each with its own officers and its own book, that
        still needs to be visible from the center. Kitabu Yetu&apos;s
        multi-group support gives an organization one login and a portfolio view
        across every group it oversees, while each group keeps its own ledger,
        private to its own members.
      </p>
      <p>
        This is one of the more established parts of the ecosystem — multi-group
        registration is live, and an existing member can found a second group
        under the same identity without re-registering from scratch.
      </p>
