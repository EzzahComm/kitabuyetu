...
export const CreateContributionSchema = z.object({
  ...
  paymentMethod: z
    .enum(["mpesa", "cash", "bank_transfer", "cheque", "standing_order"])
    .optional()
    .nullable(),
...
export const UpdateContributionSchema = z.object({
  status: z
    .enum(["pending", "completed", "failed", "cancelled", "overdue"])
    .optional(),
  paymentMethod: z
    .enum(["mpesa", "cash", "bank_transfer", "cheque", "standing_order"])
    .optional()
...
export type CreateContributionPayload = z.input<
  typeof CreateContributionSchema
>;
export type UpdateContributionPayload = z.input<
