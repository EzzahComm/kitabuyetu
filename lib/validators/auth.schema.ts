...
export const LoginSchema = z.object({
  identifier: z
    ...
    .refine((v) => v.includes('@') || isValidKenyanPhone(v), 'Enter a valid Kenyan phone number or email address'),
...
export const AdminLoginMfaVerifySchema = z.object({
  ...
  code: z.string().min(6, 'Enter the 6-digit code from your authenticator').max(20),
