...
export const CreateShareTransactionSchema = z
  ...
  .refine(
    ...
    (v) => v.type === "adjustment" || v.quantity > 0,
    {
      path: ["quantity"],
      message:
        "quantity must be positive (sign is set automatically for the chosen type)",
    },
  );
...
export type CreateShareTransactionInput = z.infer<
  typeof CreateShareTransactionSchema
>;
