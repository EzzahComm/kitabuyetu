...
export const CreateDividendDeclarationSchema = z
  .object({
    ...
    poolAmount: z.coerce
      .number()
      .positive("Pool amount must be greater than zero"),
...
export type CreateDividendDeclarationInput = z.infer<
  typeof CreateDividendDeclarationSchema
>;
export type UpdateDividendDeclarationInput = z.infer<
  typeof UpdateDividendDeclarationSchema
>;
