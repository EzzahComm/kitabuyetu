  ...
  return React.useMemo<CommandPaletteGroup[]>(() => {
    const goTo: CommandPaletteGroup = {
      ...
      commands: [
        ...
        },
        {
          ...
          label: "Contributions",
          icon: CreditCard,
          keywords: "savings deposits",
          run: go("/contributions"),
        },
        {
          id: "loans",
          label: "Loans",
          icon: Landmark,
          keywords: "lending disbursement repayment",
          run: go("/loans"),
        },
        {
          id: "mpesa",
          label: "M-Pesa",
          icon: Smartphone,
          keywords: "stk paybill b2c transactions",
          run: go("/mpesa"),
        },
        {
          id: "members",
        ...
        },
        {
          ...
          label: "Shares",
          icon: Coins,
          keywords: "share classes capital",
          run: go("/shares"),
        },
        {
          id: "dividends",
          label: "Dividends",
          icon: ReceiptText,
          keywords: "payouts distributions",
          run: go("/dividends"),
        },
        {
          id: "treasury",
        ...
        },
        {
          ...
          label: "Accounting",
          icon: BookOpen,
          keywords: "ledger journal trial balance",
          run: go("/accounting"),
        },
        {
          id: "billing",
        ...
        },
        {
          ...
          label: "SMS",
          icon: MessageSquare,
          keywords: "text messages templates",
          run: go("/sms"),
        },
        {
          id: "whatsapp",
        ...
        },
        {
          ...
          label: "Email",
          icon: Mail,
          keywords: "campaigns templates logs",
          run: go("/email"),
        },
        {
          id: "data-import",
          label: "Data import",
          icon: Upload,
          keywords: "csv migration bulk upload",
          run: go("/data-import"),
        },
        {
          id: "settings",
    ...
    const actions: CommandPaletteGroup = {
      ...
      commands: [
        {
          id: "unrouted",
          label: "View unrouted M-Pesa payments",
          hint: "M-Pesa",
          icon: Inbox,
          keywords: "unmatched pending",
          run: go("/mpesa/unrouted"),
        },
        {
          id: "reconcile",
          label: "Run M-Pesa reconciliation",
          hint: "M-Pesa",
          icon: RefreshCw,
          keywords: "stk paybill sweep",
          run: go("/mpesa/reconciliations"),
        },
        {
          id: "signout",
          label: "Sign out",
