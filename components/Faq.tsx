              ...
              {({ open }) => (
                <>
                  <DisclosureButton className="flex items-center justify-between w-full px-4 py-4 text-lg text-left text-gray-800 rounded-lg bg-gray-50 hover:bg-gray-100 focus:outline-none focus-visible:ring focus-visible:ring-indigo-100 focus-visible:ring-opacity-75 dark:bg-trueGray-800 dark:text-gray-200">
                    ...
                    <IconChevronUp size={20} className={`${open ? 'transform rotate-180' : ''} text-indigo-500`} />
                  </DisclosureButton>
...
const faqdata = [
  ...
  },
  {
    ...
    answer: 'Yes. Every plan supports bulk CSV import for members and historical contributions.',
  },
  {
  ...
  },
  {
    ...
    answer: 'No. Every plan is paid, starting at the Starter price above, and is bought self-service by M-Pesa.',
  },
];
