...
export const ECOSYSTEM_ITEMS: NavLink[] = [
  ...
  },
  {
    ...
    description: 'Grants, opportunities and interventions for qualifying groups.',
  },
];
...
export const NAV_LINKS: NavLink[] = NAV_ITEMS.flatMap((entry) => (isNavGroup(entry) ? entry.items : [entry]));
