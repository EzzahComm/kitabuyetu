    ...
    () => [
      {
        ...
        commands: [
          ...
          },
          {
            ...
            label: "Organizations",
            icon: Building2,
            keywords: "banks saccos foundations ngo federating",
            run: go("/admin/organizations"),
          },
          {
            id: "groups",
            label: "Groups",
            icon: Building2,
            keywords: "tenants chamas savings groups",
            run: go("/admin/groups"),
          },
          {
            id: "members",
          ...
          },
          {
            ...
            label: "Billing",
            icon: CreditCard,
            keywords: "revenue subscriptions invoices mrr",
            run: go("/admin/billing-admin"),
          },
          {
            id: "analytics",
            label: "Analytics",
          ...
          },
          {
            ...
            label: "Risk & Fraud",
            icon: ShieldAlert,
            keywords: "fraud kyc verification compliance heatmap",
            run: go("/admin/risk"),
          },
          {
            id: "monitoring",
            ...
            icon: Activity,
            keywords:
              "daraja mpesa sms api health transactions feed uptime latency",
            run: go("/admin/monitoring"),
          },
          {
            id: "support",
            label: "Support Center",
            icon: Headphones,
            keywords: "tickets help sla",
            run: go("/admin/support"),
          },
          {
            id: "audit",
            label: "Audit Logs",
            ...
            run: go("/admin/audit-logs"),
          },
          {
            id: "flags",
            label: "Feature Flags",
            icon: Flag,
            keywords: "toggles rollout experiments",
            run: go("/admin/feature-flags"),
          },
          {
            id: "settings",
            label: "Settings",
      ...
      },
      {
        ...
        commands: [
          {
            id: "sla",
            label: "Review SLA-breached tickets",
            hint: "Support",
            icon: Activity,
            keywords: "urgent escalation",
            run: go("/admin/support?filter=sla_breached"),
          },
          {
            id: "kyc",
            label: "Open KYC verification queue",
            hint: "Risk",
            icon: ShieldAlert,
            keywords: "verify identity pending",
            run: go("/admin/risk#kyc"),
          },
          {
            id: "signout",
            label: "Sign out",
    ...
    const commands: CommandPaletteCommand[] = [
      ...
      ...results.members.map(
        (m): CommandPaletteCommand => ({
          ...
          run: m.group_id
            ? go(`/admin/groups/${m.group_id}/members/${m.id}`)
            : go("/admin/users"),
        }),
      ),
    ];
