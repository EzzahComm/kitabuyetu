...
import { products, ecosystem, company, legal, NavItem } from '@/components/navigation';

const FooterColumn = ({ title, items }: { title: string; items: NavItem[] }) => (
  <div>
    <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
      <div className="w-full px-4 py-2 font-medium text-gray-800 dark:text-gray-200">{title}</div>
      {items.map((item) => (
        <Link
          key={item.href}
          href={item.href}
    ...
    <div className="relative">
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto border-t border-gray-100 dark:border-trueGray-700 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-7">
          ...
          <div className="">
            <div className="font-medium text-gray-800 dark:text-gray-200">Follow us</div>
