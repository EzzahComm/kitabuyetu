...
export function ShareCertificate(props: ShareCertificateProps) {
  const fullName = [props.memberFirstName, props.memberLastName]
    .filter(Boolean)
    .join(" ");
          ...
          <View style={styles.innerBorder}>
            ...
            <View style={styles.headerRow}>
              ...
              <View>
                ...
                <Text style={[styles.serial, styles.serialValue]}>
                  {props.certificateSerial}
                </Text>
              </View>
            </View>
              ...
              <Text style={styles.paragraph}>
                ...
                {props.membershipNo ? (
                  <>
                    {" "}
                    (member A/C{" "}
                    <Text style={styles.inline}>{props.membershipNo}</Text>)
                  </>
                ) : null}
                {props.memberNationalId ? (
                  <>
                    , holder of national ID{" "}
                    <Text style={styles.inline}>{props.memberNationalId}</Text>
                  </>
                ) : null}{" "}
                is the registered owner of the shares set out below, recorded
                against {TYPE_LABEL[props.txnType]}{" "}
                <Text style={styles.inline}>{props.quantity}</Text> share(s) of
                the class{" "}
                <Text style={styles.inline}>{props.shareClassName}</Text> in the
                capital of <Text style={styles.inline}>{props.groupName}</Text>.
              </Text>
              ...
              <View style={styles.detailGrid}>
                ...
                <View style={styles.detailCol}>
                  ...
                  <Text style={styles.detailValue}>
                    {fmt(props.totalValue)}
                  </Text>
                </View>
                <View style={styles.detailCol}>
                  <Text style={styles.detailLabel}>Voting weight</Text>
                  <Text style={styles.detailValue}>
                    {props.votingWeight} per share
                  </Text>
                </View>
                <View style={styles.detailCol}>
