          ...
          <View style={styles.innerBorder}>
            ...
            <View style={styles.headerRow}>
              <View>
                ...
                <Text style={styles.brandSub}>
                  ...
                  {props.isGovRegistered && props.registrationNo ? ` · Reg. ${props.registrationNo}` : ''}
                </Text>
              </View>
              <View>
            ...
            <View style={styles.body}>
              <Text style={styles.paragraph}>
                This is to certify that <Text style={styles.inline}>{fullName}</Text>
                {props.membershipNo ? (
                  <>
                    {' '}
                    (member A/C <Text style={styles.inline}>{props.membershipNo}</Text>)
                  </>
                ) : null}
                {props.memberNationalId ? (
                  <>
                    , holder of national ID <Text style={styles.inline}>{props.memberNationalId}</Text>
                  </>
                ) : null}{' '}
                is the registered owner of the shares set out below, recorded against {TYPE_LABEL[props.txnType]}{' '}
                <Text style={styles.inline}>{props.quantity}</Text> share(s) of the class{' '}
                <Text style={styles.inline}>{props.shareClassName}</Text> in the capital of{' '}
                <Text style={styles.inline}>{props.groupName}</Text>.
              </Text>
            ...
            <Text style={styles.fineprint}>Generated by Kitabu Yetu · Reference TXN {props.txnId}</Text>
          </View>
        </View>
      </Page>
    </Document>
