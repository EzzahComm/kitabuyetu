...
export function isGroupSelectionNeeded(
  r: LoginResult,
): r is NeedsGroupSelection {
...
export function isAdminEnrollment(
  r: AdminLoginResult,
): r is AdminLoginEnrollmentChallenge {
  return (r as AdminLoginEnrollmentChallenge).needsMfaEnrollment === true;
}
export function isAdminMfaChallenge(
  r: AdminLoginResult,
): r is AdminLoginMfaChallenge {
  return (r as AdminLoginMfaChallenge).needsMfaCode === true;
}
export function isOrgSelectionNeeded(
  r: AdminLoginVerifyResult,
): r is NeedsOrgSelection {
