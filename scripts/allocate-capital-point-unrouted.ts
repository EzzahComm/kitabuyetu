...
const ALLOCATIONS = [
  {
    ...
    notes:
      "Allocated: bill_ref 300004 is the tail of member code KY000000300004 (Cyril Murunga).",
  },
  {
    receipt: "UF5QT6SMNR",
    ...
    notes:
      "Allocated: C2B payload FirstName=ANTHONY matched Anthony Situma; ref was group-code only.",
  },
] as const;
...
async function main() {
  ...
  for (const a of ALLOCATIONS) {
    ...
    await resolveUnrouted(
      ...
      {
        userId: "a21e96f0-7fc6-4cb0-b28c-9e7093f5328e",
        groupId: GROUP_ID,
        role: "chairperson",
      },
      a.unroutedId,
      ...
      {
        memberId: a.memberId,
        notes: `${a.notes} (ops correction, run on the group's behalf 2026-08-26)`,
      },
    );
