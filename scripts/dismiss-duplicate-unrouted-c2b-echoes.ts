...
const ROWS = [
  {
    receipt: "UHFQZ2SPYV",
    group: "Khaka Womens Group",
    existingPayment: "eb6e200e-7995-46db-ab03-cdcaa2fec379",
  },
  {
    receipt: "UHJ1G3JL8E",
    group: "CAPITAL POINT CHAMA",
    existingPayment: "862c8a07-232a-45db-bd24-c903118db167",
  },
  {
    receipt: "UHJ1G3JNUT",
    group: "CAPITAL POINT CHAMA",
    existingPayment: "fa304a76-8b6f-492f-8d70-c5b46ecc827f",
  },
  {
    receipt: "UHJQT3FU9M",
    group: "CAPITAL POINT CHAMA",
    existingPayment: "4aae224c-067f-40cd-9162-98f80bf85a6a",
  },
  {
    receipt: "UHLJF3JS4M",
    group: "Munyali Ukulima Self Help Group",
    existingPayment: "a727e8d9-8324-4915-af75-fe4436ed4fb5",
  },
  {
    receipt: "UHLFR39EEB",
    group: "Ndengelwa Community Water Project",
    existingPayment: "5f896cef-e10e-4edf-93d8-ea17f0eaf5c6",
  },
  {
    receipt: "UHLEH3J1KY",
    group: "CAPITAL POINT CHAMA",
    existingPayment: "0701ddd8-f286-4ebf-b0f5-d9bc412d895c",
  },
] as const;
...
async function main() {
  ...
  for (const target of ROWS) {
    ...
    if (!row) {
      console.log(
        `SKIP ${target.receipt} — no unrouted row found (already resolved?)`,
      );
      continue;
    }
    if (row.resolved) {
