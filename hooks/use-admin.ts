...
import type {
  AssignableRole,
  AssignRoleResult,
} from "@/lib/services/member-roles.service";
import type {
  SubscriptionProduct,
...
import type {
  getCountyAggregation,
  getWardAggregation,
} from "@/lib/services/admin-geography.service";
import type {
  C2BUrls,
  C2BRegistrationResult,
...
type AssignGroupToOrgResult = Awaited<
  ReturnType<typeof assignGroupToOrganization>
>;
type RevokeGroupFromOrgResult = Awaited<
  ReturnType<typeof revokeGroupFromOrganization>
>;
...
type GroupGovernanceSnapshot = Awaited<
  ReturnType<typeof getGroupGovernanceSnapshot>
>;
...
type SmsOrganizationUsageList = Awaited<
  ReturnType<typeof getOrganizationUsage>
>;
...
export function useAdminRevenueTrend() {
  return useQuery({
    ...
    queryFn: () =>
      adminFetch<RevenueTrend>("/api/admin/dashboard?widget=revenue_trend"),
    staleTime: 300_000,
  });
}
...
export function useAdminGroupMembers(groupId: string, page: number) {
  return useQuery({
    ...
    queryFn: () =>
      adminFetch<AdminGroupMemberList>(
        `/api/admin/groups/${groupId}/members?page=${page}&limit=25`,
      ),
    enabled: !!groupId,
  });
}
...
export function useUpdateGroupStatus() {
  ...
  return useMutation({
    mutationFn: ({
      ...
      adminFetch<UpdateGroupResult>(`/api/admin/groups/${id}`, {
        method: "PATCH",
        json: { action, reason },
      }),
    onSuccess: () => {
...
export function useUpdateMemberProfile() {
  ...
  return useMutation({
    mutationFn: ({
      ...
      memberId,
      ...body
    }: UpdateMemberProfileInput & { groupId: string; memberId: string }) =>
      adminFetch<unknown>(`/api/admin/groups/${groupId}/members/${memberId}`, {
        method: "PATCH",
        json: body,
      }),
    onSuccess: (_data, vars) => {
...
export function useOrganizationComparison() {
  return useQuery({
    ...
    queryFn: () =>
      adminFetch<OrgComparisonList>("/api/admin/organizations/compare"),
    staleTime: 60_000,
  });
}
...
export function useCountyGeography() {
  return useQuery({
    ...
    queryFn: () =>
      adminFetch<CountyAggregationList>("/api/admin/geography/counties"),
    staleTime: 60_000,
  });
}
...
export function useWardGeography(countyId: string, enabled: boolean) {
  return useQuery({
    ...
    queryFn: () =>
      adminFetch<WardAggregationList>(
        `/api/admin/geography/counties/${countyId}/wards`,
      ),
...
export function useCreateOrganization() {
  ...
  return useMutation({
    mutationFn: (body: CreateOrgInput) =>
      adminFetch<AdminOrgCreated>("/api/admin/organizations", {
        method: "POST",
        json: body,
      }),
    onSuccess: () => {
...
export function useAssignOrganizationPlan() {
  ...
  return useMutation({
    mutationFn: ({
      ...
      adminFetch<AssignOrgPlanResult>(
        `/api/admin/organizations/${organizationId}/plan`,
        { method: "POST", json: body },
      ),
    onSuccess: (_data, vars) => {
      qc.invalidateQueries({
        queryKey: ["admin", "organization", vars.organizationId, "plan"],
      });
      qc.invalidateQueries({ queryKey: ["admin", "organizations"] });
    },
  });
...
export function useUpdateOrganizationStatus() {
  ...
  return useMutation({
    mutationFn: ({
      ...
      adminFetch<SetOrgActiveResult>(`/api/admin/organizations/${id}`, {
        method: "PATCH",
        json: { action },
      }),
    onSuccess: () => {
...
export function useAssignGroupToOrg() {
  ...
  return useMutation({
    mutationFn: ({
      ...
      adminFetch<AssignGroupToOrgResult>(
        `/api/admin/organizations/${orgId}/groups`,
        {
          method: "POST",
...
export function useRevokeGroupFromOrg() {
  ...
  return useMutation({
    mutationFn: ({ orgId, groupId }: { orgId: string; groupId: string }) =>
      adminFetch<RevokeGroupFromOrgResult>(
        `/api/admin/organizations/${orgId}/groups?groupId=${groupId}`,
        {
          method: "DELETE",
        },
      ),
...
export function useMyOrganizations() {
  return useQuery({
    ...
    queryFn: () =>
      adminFetch<{ items: MyOrganizationSummary[] }>(
        "/api/admin/auth/my-organizations",
      ),
  });
}
...
export function useSwitchOrg() {
  return useMutation({
    mutationFn: (organizationId: string) =>
      adminFetch<SwitchOrgResult>("/api/admin/auth/switch-org", {
        method: "POST",
        json: { organizationId },
      }),
  });
...
export function useOrgStaff(orgId: string) {
  return useQuery({
    ...
    queryFn: () =>
      adminFetch<OrgStaffList>(`/api/admin/organizations/${orgId}/staff`),
    enabled: !!orgId,
  });
}
...
export function useAddOrgStaff() {
  ...
  return useMutation({
    ...
    onSuccess: (_d, v) => {
      qc.invalidateQueries({
        queryKey: ["admin", "organizations", v.orgId, "staff"],
      });
    },
  });
}
...
export function useInviteOrgStaff() {
  ...
  return useMutation({
    mutationFn: ({ orgId, ...body }: { orgId: string } & InviteOrgStaffInput) =>
      adminFetch<InviteOrgStaffResult>(
        `/api/admin/organizations/${orgId}/staff/invite`,
        {
          method: "POST",
          json: body,
        },
    ...
    onSuccess: (_d, v) => {
      ...
      qc.invalidateQueries({
        queryKey: ["admin", "organizations", v.orgId, "invitations"],
      });
    },
  });
}
...
export function useOrgInvitations(orgId: string) {
  return useQuery({
    ...
    queryFn: () =>
      adminFetch<OrgInvitationList>(
        `/api/admin/organizations/${orgId}/staff/invitations`,
      ),
    enabled: !!orgId,
  });
}
...
export function useResendOrgInvitation() {
  ...
  return useMutation({
    mutationFn: ({
      ...
      adminFetch<ResendInvitationResult>(
        `/api/admin/organizations/${orgId}/staff/invitations/${invitationId}/resend`,
        {
          method: "POST",
        },
      ),
  ...
  return useMutation({
    mutationFn: ({
      ...
      adminFetch<{ id: string }>(
        `/api/admin/organizations/${orgId}/staff/invitations/${invitationId}`,
        {
          method: "DELETE",
        },
      ),
  ...
  return useMutation({
    mutationFn: ({
      ...
      adminFetch<{ success: true }>(
        `/api/admin/organizations/${orgId}/staff/${memberId}`,
        {
          method: "PATCH",
          json: { orgRole },
        },
...
export function useUpdateUserRole() {
  ...
  return useMutation({
    mutationFn: ({ id, platformRole }: { id: string; platformRole: string }) =>
      adminFetch<UpdateUserRoleResult>(`/api/admin/users/${id}`, {
        method: "PATCH",
        json: { platformRole },
      }),
...
export function useAssignableRoles(groupId?: string | null) {
  return useQuery({
    ...
    queryFn: () =>
      adminFetch<{ items: AssignableRole[] }>(
        `/api/admin/roles?groupId=${groupId}`,
      ),
    enabled: !!groupId,
    staleTime: 5 * 60_000,
  });
...
export function useCreateTicket() {
  ...
  return useMutation({
    mutationFn: (data: CreateTicketInput) =>
      adminFetch<CreatedTicket>("/api/admin/support", {
        method: "POST",
        json: data,
      }),
...
export function useUpdateTicket() {
  ...
  return useMutation({
    mutationFn: ({
      ...
      adminFetch<UpdatedTicket>(`/api/admin/support/${id}`, {
        method: "PATCH",
        json: data,
      }),
    onSuccess: () => {
...
// ─────────────────────────────────────────────────────────────────────────────
export function useAdminUnroutedPayments(
  ...
  return useQuery({
    ...
    queryFn: () =>
      adminFetch<UnroutedPaymentList>(`/api/admin/mpesa/unrouted?${p}`),
    staleTime: 20_000,
  });
}
...
export function useResolveUnroutedPayment() {
  ...
  return useMutation({
    mutationFn: ({
      ...
      adminFetch<ResolveUnroutedResult>(`/api/admin/mpesa/unrouted/${id}`, {
        method: "PATCH",
        json: data,
      }),
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["admin", "mpesa-unrouted"] }),
  });
}
...
export function useRegisterC2BUrls() {
  ...
  return useMutation({
    ...
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["admin", "mpesa", "c2b-urls"] }),
  });
}
...
export function useToggleFeatureFlag() {
  ...
  return useMutation({
    mutationFn: ({ key, enabled }: { key: string; enabled: boolean }) =>
      adminFetch<ToggleFeatureFlagResult>("/api/admin/feature-flags", {
        method: "PATCH",
        json: { key, enabled },
      }),
    onSuccess: () =>
...
export function useGovernanceAlerts(
  ...
  return useQuery({
    ...
    queryFn: () =>
      adminFetch<GovernanceAlertList>(`/api/admin/governance/alerts?${p}`),
    staleTime: 20_000,
    refetchInterval: 60_000,
  });
}
...
export function useAcknowledgeGovernanceAlert() {
  ...
  return useMutation({
    ...
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["admin", "governance", "alerts"] }),
  });
}
...
export function useGroupGovernanceSnapshot(groupId: string) {
  return useQuery({
    ...
    queryFn: () =>
      adminFetch<GroupGovernanceSnapshot>(
        `/api/admin/governance/snapshots?groupId=${groupId}`,
      ),
    enabled: !!groupId,
    staleTime: 60_000,
  });
...
export function useActivateSmsTiers() {
  ...
  return useMutation({
    ...
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["admin", "sms-pricing"] }),
  });
}
...
export function useSmsMargin(from?: string, to?: string) {
  ...
  return useQuery({
    ...
    queryFn: () =>
      adminFetch<SmsMarginResponse>(`/api/admin/sms-margin${suffix}`),
    staleTime: 60_000,
  });
}
...
export function useAdminTopUpOrganizationSmsCredits() {
  ...
  return useMutation({
    mutationFn: ({
      organizationId,
      ...body
    }: TopUpSmsCreditsInput & { organizationId: string }) =>
      adminFetch<{
        creditsAdded: number;
        newBalance: number;
        rateApplied: number;
    ...
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["admin", "sms-margin"] }),
  });
}
  ...
  return useMutation({
    mutationFn: ({
      ...
      adminFetch<{ organizationId: string; rate: number }>(
        `/api/admin/organizations/${organizationId}/sms-rate`,
        { method: "POST", json: { rate } },
      ),
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["admin", "sms-margin"] }),
  });
...
export function useAdminSearch(query: string) {
  ...
  return useQuery({
    ...
    queryFn: () =>
      adminFetch<PlatformSearchResults>(
