...
export const accountingKeys = {
  ...
  balanceSheet: (asOf?: string) =>
    ["accounting", "balance-sheet", asOf] as const,
...
export function useCreateJournal() {
  ...
  return useMutation({
    mutationFn: (body: CreateJournalPayload) =>
      accountingApi.createJournal(body),
...
export function useClosePeriod() {
  ...
  return useMutation({
    ...
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: accountingKeys.fiscalPeriods }),
  });
}
...
export function useReopenPeriod() {
  const qc = useQueryClient();
  return useMutation({
    mutationFn: ({ id, reason }: { id: string } & ReopenPeriodInput) =>
...
export function usePostingTemplates() {
  return useQuery({
    queryKey: accountingKeys.postingTemplates,
    queryFn: accountingApi.postingTemplates,
  });
}
...
export function useSetPostingTemplate() {
  const qc = useQueryClient();
  return useMutation({
    mutationFn: (body: SetPostingTemplatePayload) =>
      accountingApi.setPostingTemplate(body),
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: accountingKeys.postingTemplates }),
  });
}
...
export function useSetApprovalPolicy() {
  ...
  return useMutation({
    ...
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: accountingKeys.policies }),
  });
}
